...
"""
        ...
        try:
            summary = await self.generate(
                ...
                system_prompt=system_prompt,
                temperature=0.5,
                max_tokens=max_length * 2  # 中文token估算
            )
...
"""
    ...
    async def health_check(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Claude健康检查失败: {str(e)}")
            return False
