    ...
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-to-b from-primary-50 to-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-5xl font-serif font-bold text-gray-900 mb-6">
            AI-Powered Legal Case Research
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Access millions of legal cases instantly. Get AI-generated summaries,
            entity extraction, and similarity search - at 1/10th the cost of traditional services.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Powered by CourtListener's comprehensive legal database and cutting-edge AI.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 rounded-xl bg-gray-50">
              ...
              <p className="text-gray-600">
                Get instant case summaries generated by Claude AI.
                Understand key facts, holdings, and reasoning in seconds.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-gray-50">
              ...
              <p className="text-gray-600">
                Natural language search across millions of legal cases.
                Filter by court, date, citation, and more.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-gray-50">
              ...
              <h3 className="text-xl font-semibold mb-2">Similar Cases</h3>
              <p className="text-gray-600">
                Find related cases using AI-powered similarity search.
                Discover precedents you might have missed.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            <div className="bg-primary-50 p-6 rounded-xl border-2 border-primary-200">
              <h3 className="text-xl font-semibold mb-2 text-primary-900">Pro</h3>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="mt-4 text-sm">© 2024 CrimeJournal. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
