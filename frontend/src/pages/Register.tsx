...
import { Scale, Mail, Lock, User, Eye, EyeOff, ArrowRight, Sparkles } from 'lucide-react'
...
export default function Register() {
  ...
  const isProPlan = searchParams.get('plan') === 'pro'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Pydantic v2 returns validation errors as object arrays in err.response.data.detail
      ...
      if (rawDetail) {
        if (typeof rawDetail === 'string') {
          ...
          // Pydantic v2 format: [{type, loc, msg, input, ctx}]
          errorMsg = rawDetail.map((e: any) => e.msg || String(e)).join('; ')
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative">
          ...
          <h2 className="text-4xl font-serif font-bold text-white leading-tight mb-6">
            {t('register.heroTitle').split('\n')[0]}<br />
            <span className="text-amber-300">{t('register.heroTitle').split('\n')[1]}</span>
          </h2>
          ...
          <div className="flex flex-wrap gap-3 mt-8">
            {[t('register.featureFreeSearches'), t('register.featureAiSummaries'), t('register.featureEntityExtraction')].map((tag) => (
        ...
        <div className="relative pt-6 border-t border-white/10">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center flex-shrink-0 text-sm font-bold text-white">
              JD
            </div>
            <div>
              <p className="text-sm text-white/60 italic leading-relaxed">
                "Finally, a tool that makes legal research accessible. The AI summaries save me hours every week."
              </p>
              <p className="text-xs text-amber-300/70 mt-2">— Jane D., Legal Researcher</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm">
                Create your free account and start researching
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  />
                  <User className="absolute start-3.5 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 dark:text-gray-500 group-focus-within:text-primary-500 dark:group-focus-within:text-primary-400 transition-colors pointer-events-none z-10" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <input
                    ...
                    style={{ paddingLeft: '2.75rem' }}
                  />
                  <Mail className="absolute start-3.5 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 dark:text-gray-500 group-focus-within:text-primary-500 dark:group-focus-within:text-primary-400 transition-colors pointer-events-none z-10" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500">{t('register.passwordHint')}</p>
              </div>
